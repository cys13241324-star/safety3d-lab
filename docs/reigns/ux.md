...
> **2026-09-07 현재 — 열넷 가운데 열셋이 닫혔다.** 파일을 뒤져 확인한 값이다.
>
> | 닫힘 | 어디에서 |
> |---|---|
...
>
> **남은 것은 D11(사이트 공통 테마) 하나다.** 형제 다섯은 `safety_theme` 을 읽어
> 밝은 판으로 바뀌는데 reigns 만 `color-scheme:dark` 고정이다. 팔레트 변수 스물을
> 밝은 쪽으로 새로 정해야 해서 한 줄로 끝나지 않는다.
>
